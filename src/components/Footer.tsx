...
const Footer = () =>  (
    <section id='IdFooter' className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className="flex-1 flex flex-col justify-start mr-10">
          <img src={logo} alt='MELearning' 
          className="w-[266px] h-[90px]"
          object-contain
          />
          <p className={`${styles.paragraph} mt-4 max-w-[350px]`}>
          Mastering and empowering learning!!!   
            </p>
        </div>
      ...
      ">
        <p className={`font-poppins font-normal text-center text-[18px]
              leading-[27px] text-white
              `}>
        Copyright &copy; {new Date().getFullYear()} <span className="text-gradient">ME Learning</span>{" "}. All rights reserved.
        </p>
